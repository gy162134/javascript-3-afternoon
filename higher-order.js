...
//Code Here
let evenNumbers = mixedNumbers.filter(arr => arr%2 === 0)
...
//Code Here
let postTaxPrices = prices.map(arr => arr * 1.07)
...
let ordersTotal = orders.map(arr => arr.price + arr.tax)
...
let bobsTotal = purchases.reduce((a,b) => ({price: a.price + b.price}))
